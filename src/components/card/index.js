...
import { FaRegStar, FaRegEdit, FaRegTrashAlt, FaRegCheckCircle, FaRegTimesCircle } from "react-icons/fa";
import { addFav, addNote, completeTask, removeTask } from '../../redux/todos/actions';
import { CardContainer, CardHeader, CardBody, CardRow, CardFooter } from "./styles";
    ...
    <CardFooter>
      <div>
        <input
          ...
          value={note}  
        />
        <Button title="Add Note" onClick={handleNoteAdd} disabled={!note.length} />
      </div>
      <Button
        disabled={completed}
